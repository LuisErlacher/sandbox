...
WORKFLOW_INSTRUCTIONS="${PROJECT_ROOT}/.bmad/bmm/workflows/4-implementation/dev-story/instructions.md"
...
5. Execute o workflow dev-story seguindo TODAS as instruções do arquivo de instruções
6. Implemente TODAS as tasks e subtasks da story
7. Siga TODOS os acceptance criteria
8. Escreva testes e valide a implementação
9. Atualize o arquivo da story marcando tasks como concluídas
...
**WORKFLOW A EXECUTAR:**
Execute o workflow dev-story seguindo as instruções em: $WORKFLOW_INSTRUCTIONS
