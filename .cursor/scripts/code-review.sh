...
WORKFLOW_FILE="${PROJECT_ROOT}/.bmad/bmm/workflows/4-implementation/code-review/workflow.yaml"
WORKFLOW_INSTRUCTIONS="${PROJECT_ROOT}/.bmad/bmm/workflows/4-implementation/code-review/instructions.md"
...
5. Execute o workflow code-review seguindo TODAS as instruções do arquivo de instruções
6. Realize uma revisão completa de código seguindo os padrões do BMad Method
7. Aplique todos os critérios de validação do workflow
8. Adicione notas estruturadas de revisão à story
...
**WORKFLOW A EXECUTAR:**
Execute o workflow code-review seguindo as instruções em: $WORKFLOW_INSTRUCTIONS
