...
WORKFLOW_FILE="${PROJECT_ROOT}/.bmad/bmm/workflows/4-implementation/create-story/workflow.yaml"
WORKFLOW_INSTRUCTIONS="${PROJECT_ROOT}/.bmad/bmm/workflows/4-implementation/create-story/instructions.md"
...
4. Execute o workflow create-story seguindo TODAS as instruções do arquivo de instruções
5. Crie a story seguindo o template padrão do BMad Method
6. Use os epics, PRD e arquitetura disponíveis como referência
7. Salve a story em: ${SPRINT_ARTIFACTS}/${STORY_NAME}.md
8. Siga todos os critérios de validação do workflow
...
**WORKFLOW A EXECUTAR:**
Execute o workflow create-story seguindo as instruções em: $WORKFLOW_INSTRUCTIONS
