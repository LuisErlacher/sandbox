...
WORKFLOW_FILE="${PROJECT_ROOT}/.bmad/bmm/workflows/4-implementation/story-context/workflow.yaml"
WORKFLOW_INSTRUCTIONS="${PROJECT_ROOT}/.bmad/bmm/workflows/4-implementation/story-context/instructions.md"
...
5. Execute o workflow story-context seguindo TODAS as instruções do arquivo de instruções
6. Monte um Story Context XML dinâmico puxando a documentação mais recente
7. Inclua artefatos de código/biblioteca relevantes para a story
8. Use o template do workflow para estruturar o contexto
9. Salve o arquivo de contexto em: ${SPRINT_ARTIFACTS}/${STORY_NAME}.context.xml
...
**WORKFLOW A EXECUTAR:**
Execute o workflow story-context seguindo as instruções em: $WORKFLOW_INSTRUCTIONS
